	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-6 p-0">
				<div class="categories__item categories__large__item set-bg" data-setbg="{{ asset('User/img/product/category-2.jpg')}}">
				...
				<div class="product__item">
					<div class="product__item__pic set-bg" data-setbg="{{ asset('User/img/product/product-6.jpg')}}">
						...
						<ul class="product__hover">
							<li><a href="{{ asset('User/img/product/product-1.jpg')}}" class="image-popup"><span class="arrow_expand"></span></a></li>
		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-4 col-sm-6">
				<div class="trend__content">
					...
					<div class="trend__item">
						<div class="trend__item__pic">
							<img src="{{ asset('User/img/trend/bs-2.jpg')}}" alt="">
						</div>
						<a href="#">
							<div class="trend__item__text">
		...
		<div class="row">
			<div class="col-lg-6 p-0">
				<div class="discount__pic">
					<img src="{{ asset('User/img/discount.jpg')}}" alt="">
				</div>
			</div>
			<div class="col-lg-6 p-0">
